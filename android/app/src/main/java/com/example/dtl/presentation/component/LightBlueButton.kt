...
@Composable
fun LightBlueButton(modifier: Modifier = Modifier, text: String, enabled: Boolean = true, onClick: () -> Unit) {
    Button(
        modifier = modifier,
        shape = RoundedCornerShape(12.dp),
        colors = ButtonDefaults.buttonColors(
            containerColor = ButtonLightestBlue,
...
@Preview
@Composable
fun LightBlueButtonPreview() {
    LightBlueButton(text = "Hello", enabled = false) { }
}